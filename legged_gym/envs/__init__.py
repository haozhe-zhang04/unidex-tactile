...
from legged_gym.envs.wuji.left_wuji_pos_force_config import LeftWujiPosForceRoughCfg, LeftWujiPosForceRoughCfgPPO
...
task_registry.register( "left_wuji_pos_force", WujiRobot_pos_force, LeftWujiPosForceRoughCfg(), LeftWujiPosForceRoughCfgPPO())